...
- Follow the `trip-html-theme-builder` skill, in this order:
  ...
  5. Keep the required markup shapes: packing items are ALWAYS checkboxes (`<li><input type="checkbox">…</li>`); travel tips are ALWAYS a bullet-point list (`<li>` in `ul.tips-list`) — never tables, numbered lists, or prose.
